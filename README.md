...
### https://dplatonova1.github.io/mesto-project/
Проектная работа №11 включает в себя:

  - отработку модулей JS
  - сборку кода на сборщике Webpack
...
```sh
$ git clone https://github.com/dplatonova1/mesto-project/
```
...
### Актуальная версия проекта: 0.0.6
